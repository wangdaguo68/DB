...
var App = {
     ...
     * */
    InitDom: function () {
        var dom_a = '<div id="area_a" class="active container-fluid hundred-height">';
        ...
        dom_a = dom_a + '</div>';
        var dom_b = '<div id="area_b" class="hidden container-fluid hundred-height">';
        ...
        dom_b = dom_b + '</div>';
        var dom_c = '<div id="area_c" class="hidden container-fluid hundred-height">';
        ...
        dom_c = dom_c + '</div>';
        var dom_d = '<div id="area_d" class="hidden container-fluid hundred-height">';
        ...
        dom_d = dom_d + '</div>';
        var dom = dom_a + dom_b + dom_c + dom_d;
        $("#body").html(dom);
        for (var i = 0; i < 40; i++) {
            option1[i] = option;
            option2[i] = option;
    ...
    CreateBox: function (num) {
        ...
        doc = doc + '<div class="col-md-1"> <img src="images/robot.ico" class="img-css" alt=""/></div>';
        doc = doc + '<div class="col-md-5 p-name" id="name_' + num + '"></div>';
        doc = doc + '<div class="col-md-4 p-num" id="num_' + num + '"></div>';
        doc = doc + '</div>';
        doc = doc + '<div class="row">';
        doc = doc + '<progress class="process" id="process_' + num + '"></progress>';
        doc = doc + '<p class="process-p" id="processnum_' + num + '"></p>';
        doc = doc + '</div>';
        doc = doc + '<div class="row">';
        doc = doc + '<div id="main_' + num + '1" class="chart-css"></div>';
        doc = doc + '<div id="main_' + num + '2" class="chart-css"></div>';
        doc = doc + '<div id="main_' + num + '3" class="chart-css"></div>';
        doc = doc + '</div>';
        doc = doc + '</div>';
        doc = doc + '</div>';
        return doc;
